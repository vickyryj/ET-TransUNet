# ET-TransUNet
This repo holds code for [ET-TransUNet: ET-TransUNet: Integrating EMs-RstTrans with Triple Attention for Robust Noise Suppression and Feature Enhancement in Medical Image Segmentation]
